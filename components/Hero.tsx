        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center lg:gap-16">
          <div>
            ...
            <p className="mt-6 max-w-2xl text-lg leading-relaxed text-white/80 sm:text-xl">
              Familia Fantasia, tres generaciones al servicio de la
              industria: reparación y mantenimiento de motores, tableros
              eléctricos, extractores, electrobombas y grupos electrógenos,
              con presencia en Mendoza y provincias de todo el país.
            </p>
          ...
          <div className="relative mx-auto aspect-[4/5] w-full max-w-sm overflow-hidden rounded-2xl border border-navy-100 shadow-2xl lg:max-w-none">
            <Image
              src="/images/generador-campo.jpeg"
